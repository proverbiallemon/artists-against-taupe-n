  ...
  return (
    <div className="min-h-screen bg-background text-textColor pt-20">
      <div className="max-w-screen-lg mx-auto p-5">
        <h1 className="text-5xl font-bold text-primary mb-8">Beyond Beige</h1>
        
        <div className="bg-gray-100 rounded-lg shadow-lg p-8 text-gray-800">
          ...
          <p className="mb-4 font-bold">
            ...
            <img 
              src="/images/mause/502mause.jpg" 
              alt="502 Mause" 
              className="mause-image float-right ml-4 mb-4 w-64 h-auto rounded shadow"
              onError={(e) => {
                e.currentTarget.src = '/images/mause/502mause.webp';
              }}
            /> 
